                        ...
                        <div class="row">
                            <fieldset class="border p-2 mx-auto mb-3">
                                ...
                                <div class="form-check mb-3">
                                    <input type="checkbox" {{ $releve->isLast == 1 ? 'checked' : '' }}
                                        class="form-check-input" id="toggleCigaretteFields" name="isLast"
                                        onchange="toggleCigaretteFieldsVisibility()">
                                            ...
                                            <div class="col-12">
                                                <div class="mb-3">
                                                    <input class="form-control text-dark" type="number" step="0.01"
                                                        id="recette_cigarettes"
                                                        value="{{ $boutique == null ? 0 : $boutique->cigarettes_recette }}"
                                                        placeholder="" name="recette_cigarettes" required
                                                        @if (!$releve->isLast) disabled @endif />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="col-12">
                                                <div class="mb-3">
                                                    <input class="form-control text-dark" type="number" step="0.01"
                                                        ...
                                                        placeholder="" name="qte_cigarettes" required
                                                        @if (!$releve->isLast) disabled @endif />
                                                </div>
                                            </div>
                                        </div>
