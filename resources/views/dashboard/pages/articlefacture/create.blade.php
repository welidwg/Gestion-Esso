...
<div class="container py-4">
    ...
    <form method="POST" action="{{ route('articlefacture.store') }}">
        ...
        <div class="mb-3">
            ...
            <input type="number" step="0.01" class="form-control @error('prix_unite') is-invalid @enderror" id="prix_unite" name="prix_unite" value="{{ old('prix_unite') }}">
            @error('prix_unite') <div class="invalid-feedback">{{ $message }}</div> @enderror
        </div>
